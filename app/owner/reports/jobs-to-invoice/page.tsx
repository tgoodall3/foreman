    ...
    <div className="p-6 max-w-5xl space-y-4">
      <div className="flex items-center justify-between">
        <div>
          ...
          <h1 className="font-display font-800 text-3xl text-forge leading-tight">Jobs Ready to Invoice</h1>
        ...
        <Link
          ...
          className="bg-amber text-forge font-display font-700 px-4 py-2.5 rounded-lg text-sm shadow-sm hover:bg-amber-dark transition-colors"
        >
          New Invoice
        </Link>
      </div>
